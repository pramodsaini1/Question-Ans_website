<%-- 
    ...
    Created on : 1 May, 2022, 4:14:33 PM
    Author     : Genius
--%>
				  ...
				  <div class="container-fluid">
                                <div class="row">
                                    ...
                                    <div class="col-sm-12 w3-card w3-white">
                                        ...
                                        <div class="col-sm-12" ><strong><center><h2>User Profile</h2></center></strong></div><br><br><br><br>
                                        <div class="col-sm-8">
                                        </div>
                                        <div class="col-sm-4">
                                            <button class="btn btn-warning"><a style="text-decoration:none;color:white" href="user_edit.jsp"> <i class="fa fa-edit"></i>&nbsp;&nbsp;Edit Profile</a></button>
                                        </div>
                                        <div class="col-sm-4">
                                        ...
                                        <div class="col-sm-8">
                                            <table class="table table-borderless">
                                                <tr>
                                                    <td>Display Name:</td><td><%=rs.getString("name")%></td></tr>
                                                <tr><td>Email-Id:</td><td><%=rs.getString("email")%></td></tr>
                                                <tr><td>Mobile No.:</td><td><%=rs.getString("phone")%></td>
                                                </tr>
                                                 
                                                <tr><td>Intersted:</td><td>
                                                    <%
                                                  String s = rs.getString("intersted");
                                                     String p[] = s.split(",");
                                        ...
                                        <div class="col-sm-12 w3-card w3-white">
                                            ...
                                            <div class="col-sm-4" style="border-style:solid;">
                                                ...
                                                <table class="table table-borderless">
                                                    <tr>
                                                        <td><span>0</span>&nbsp;&nbsp;reputation</td>
                                                        <td><span>0</span>&nbsp;&nbsp;reached</td>
                                                    </tr>
                                                    <tr>
                                                        <td><span>0</span>&nbsp;&nbsp;answers</td>
                                                        <td><span>0</span>&nbsp;&nbsp;questions</td>
                                                    </tr>
                                             ...
                                             <div class="col-sm-8">
                                                  <label>About:</label>
                                                 <textarea class="form-control" style="resize:none;" placeholder="Your about me section is currently blank. Would you like to add one?" rows="4" cols="7"></textarea>
                                            </div><br><br> 
                                            <div class="col-sm-4" style="border-style:solid;">
                                                <label>Communities:</label><br><br>
                                                <strong>Qn & A Website</strong>
                                            </div>
                                            <div class="col-sm-8">
                                                <label>Badge:</label>
                                                <textarea class="form-control" style="resize:none;" placeholder=" You have not earned any badges." rows="4" cols="7"></textarea>
                                            </div>
                                            <div class="col-sm-4"></div>
                                            <div class="col-sm-8">
                                                <label>Post:</label>
                                                <textarea class="form-control" style="resize:none;" placeholder="Just getting started? Try answering a question!

Your most helpful questions, answers and tags will appear here. Start by answering a question or selecting tags that match topics you’re interested in." rows="7" cols="7"></textarea><br><br>
                                            </div>
                                        </div>    
