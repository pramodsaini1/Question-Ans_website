<%-- 
    Document   : ansQue
    Created on : 28 Apr, 2022, 5:57:10 PM
    Author     : Genius
--%>
				  ...
				  <div class="container-fluid">
                                <div class="row">
                                    ...
                                    <div class="col-sm-12 w3-card w3-white">
                                        ...
                                        <div class="col-sm-12" ><strong><center><h2>Your Questions Answer</h2></center></strong></div><br><br><br><br>
                                        <h4><center><strong>Your All Questions Answer Are Shown Here.</strong></center></h4><br><br><br>
                                             ...
                                             while(rs1.next()){
                                                ...
                                                <div class="col-sm-12" style="border-bottom:1px solid wheat;border-top:1px solid wheat;">
                                                       ...
                                                       <div class="col-sm-10">
                                                           ...
                                                           <pre id="pk-<%=rs1.getString("title")%>"><%=rs1.getString("description")%></pre><br>
                                                           <div class="col-sm-7"></div>
                                                           <div class="col-sm-5">
                                                            <%
                                                       Statement sp = cn.createStatement();
                                                       ResultSet rp = sp.executeQuery("select * from user where email='"+rs1.getString("email")+"'");
                                                       out.print("<table class='table table-borderless'>");
                                                       if(rp.next()){
                                                           %>
                                                             <tr><td><td><strong>Asked</strong>&nbsp;&nbsp;<%=rs1.getString("dt")%></td></td></tr>
                                                           <%
                                                 
                                                      %>
                                                       <tr><td><img src="profile/<%=rp.getString("code")%>.jpg" style="width:40px;height:40px;"</td><td><%=rp.getString("name")%></td></tr>
                                                    <%
                                                       }
                                                       out.print("</table>");
                                                    %>
                                                           ...
                                                           <div class="col-sm-12"><strong>Answer</strong></div>
                                                           <%
                                                           Statement st2 = cn.createStatement();
                                                           ResultSet rs2 = st2.executeQuery("select * from ansquestoin where quecode='"+rs1.getString("code")+"' AND status=0");
                                                           while(rs2.next()){
                                                               %>
                                                                <pre><%=rs2.getString("ans")%></pre><br>
                                                                <div class="col-sm-7"></div>
                                                           <div class="col-sm-5">
                                                            <%
                                                       Statement sp1 = cn.createStatement();
                                                       ResultSet rp1 = sp1.executeQuery("select * from user where email='"+rs2.getString("email")+"'");
                                                       out.print("<table class='table table-borderless'>");
                                                       if(rp1.next()){
                                                           %>
                                                             <tr><td><td><strong>Answered</strong>&nbsp;&nbsp;<%=rs2.getString("dt")%></td></td></tr>
                                                           <%
                                                 
                                                      %>
                                                       <tr><td><img src="profile/<%=rp1.getString("code")%>.jpg" style="width:40px;height:40px;"</td><td><%=rp1.getString("name")%></td></tr>
                                                    <%
                                                       }
                                                       out.print("</table>");
                                                    %>
