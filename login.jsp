<%-- 
    Document   : login
    Created on : 25 Apr, 2022, 11:27:25 PM
    Author     : Genius
--%>
			...
			<div class="header-right">
				<div class="profile_details_left"><!--notifications of menu start -->
					<ul class="nofitications-dropdown">
                                            <li>
                                                <a style="text-decoration:none;margin-top:20px;" href="login.jsp"><strong><h2>Login</h2></strong></a>
                                            </li>   
					</ul>
					<div class="clearfix"> </div>
				</div>
				  ...
				  <div class="container-fluid">
                                <div class="row">
                                    ...
                                    <div class="col-sm-8 w3-card w3-white">
                                        <div class="col-sm-12" ><strong><center>Login</center></strong></div><br><br>
                                        ...
                                        <p style="font-family: vardana;">Don't have account ?</p>
                                        <a style="text-decoration: none;" href="Register.jsp"><button class="btn btn-danger">Sign-Up</button></a>
                                        <br><br><br>
                                    </div>
                                    <div class="col-sm-2">
                                     </div>
