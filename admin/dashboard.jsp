<%-- 
    Document   : dashboard
    Created on : 23 Apr, 2022, 4:24:54 PM
    Author     : Genius
--%>
								...
								<div class="profile_img">	
 									<div class="user-name">
                                                                            <%
                                                                             if(email==null){
                                                                            %>
										<p style="margin-right:-500px;margin-top:-20px;"><a href="index.jsp">Admin Login</a></p>
                                                                                <%
                                                                             }
                                                                             else{
                                                                                 %>
				 ...
				 <div class="container-fluid">
                                <div class="row">
                                    ...
                                    <div class="col-sm-8 w3-card w3-white">
                                        ...
                                        <div class="col-sm-12" ><strong><center><h3>Dashboard</h3></center></strong></div><br><br><br><br>
                                        <h2><strong>Welcome Admin</strong></h2><br><br><br>
                                        <p font-family: vardana;">You can Edit Your Users Profile & Manage Whole Website</p><br><br><br>
                                    </div>
                                    <div class="col-sm-2">
                                     </div>
                                </div><br><br>
